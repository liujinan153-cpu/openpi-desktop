...
await sleep(1500);
// 用本地文件路径（pi 的 image block 支持 file path，会读取工作区/绝对路径图片）
await ev(`(async()=>{
  state.images = [
    { data: "C:/Users/admin/AppData/Roaming/pi-desktop/clipboard-images/pi-clipboard-ebd35abc-cb4a-44c0-b050-b4331119c3a2.png", mimeType: "image/png" },
    { data: "C:/Users/admin/AppData/Roaming/pi-desktop/clipboard-images/pi-clipboard-1fe51088-ebc2-4dbb-bc9e-a223a4fed457.png", mimeType: "image/png" }
  ];
